...
Parfois, les pensées sont tellement forte, que les évènements deviennent réels.#speaker:Mr.Champignon #portrait:mr_champignon_neutral #layout:left #QTEConcentration:10,7
...
Je vais vous donner le sujet du projet ! Vous allez devoir programmer un réseau neuronnal avec deux hémisphères ! #speaker:Mr.Champignon #portrait:mr_champignon_neutral #layout:left #response:bad #QTEConcentration:5,7
...
=== mauvaiseReponse2 ===
Tu n'es composé que de cerveau droit ! #speaker:Mr.Champignon #portrait:mr_champignon_neutral #layout:left
-> suiteCours

=== bonneReponse1 ===
Oui et le droit est là pour nous faire paniquer sans raison apparente. #speaker:Mr.Champignon #portrait:mr_champignon_neutral #layout:left
-> suiteCours


=== bonneReponse2 ===
Oui c'est peut-être l'une des meilleures choses à faire...C'est difficile certe ! #speaker:Mr.Champignon #portrait:mr_champignon_neutral #layout:left
-> finCours

=== mauvaiseReponse3 ===
Un peu trop radicale... #speaker:Mr.Champignon #portrait:mr_champignon_neutral #layout:left
-> finCours

=== reponseNeutre1 ===
Oui c'est une solution mais parfois ce n'est pas la meilleure #speaker:Mr.Champignon #portrait:mr_champignon_neutral #layout:left
-> finCours
